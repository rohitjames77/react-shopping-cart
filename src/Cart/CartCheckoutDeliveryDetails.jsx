      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              <button type="" className=" relative left-[55%] bottom-[8%] h-[5vh] w-[20vw] row-start-3 row-end-6 col-start-4 col-end-8 bg-blue-500 text-white font-bold font-poppins rounded-lg p-2 active:translate-y-[4px] active:shadow-lg active:bg-blue-800 ">Proceed to Payments</button>
            </form>
          </div>
        </div>
]        
        ...
        >
          ...
          >
            ...
            <div id="total-price-discount-container" className="flex flex-col order-2 ">
              <div id="cart-quantity-heading-container" className="grid grid-rows-1 grid-cols-6">
                <AiOutlineShoppingCart className=" row-start-1 col-start-1 h-1/2 justify-self-end place-self-center" /> 
              <span id="item-quantity-heading" className=" row-start-1 col-start-2 col-end-5 text-lg">Item(s) in a cart
              </span>
              <span
                id="details-title"
            ...
            >
              <span id="sub-total-heading" className="row-start-1">Order Subtotal</span>
              <span id="sub-total-quantity" className="row-start-1 col-start-3">$SubTotal</span>
              <span id="discount-heading" className="row-start-2 col-start-1">Sale Discount</span>
              <span id="discount-quantity" className="row-start-2 col-start-3">$ Sale discount</span>
              <span id="net-subtotal-heading" className="row-start-3 col-start-1 col-end-3 font-bold">Net Order Subtotal</span>
              <span id="net-subtotal-quantity" className="row-start-3 col-start-3">$</span>
              <span id="shipping-heading" className="row-start-4 col-start-1">Shipping</span>
              <span id="shipping-price" className="row-start-4 col-start-3">$shipping price</span>
              <span id="pre-tax-total-heading" className="row-start-5 col-start-1 font-bold">Pre-Tax Total</span>
              <span id="pre-tax-total-quantity" className="row-start-5 col-start-3">$</span>
            </div>
           
          </div>
           <div id="total-saving-container"className="grid grid-rows-1 grid-cols-3  ">
              <span id="total-saving-heading" className="row-start-1 col-start-2 justify-self-start text-xl font-bold ">Total Savings</span>
              <span id="total-saving-quantity" className="row-start-1 col-start-3 justify-self-start text-lg text-red-600 font-bold  ">$</span>
            </div>
        </div>
      </div>
    </div>
