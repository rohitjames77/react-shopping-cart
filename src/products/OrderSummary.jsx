...
function OrderSummary({selectedProductArr,setPaymentProceeded}) {
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span id="sub-total-quantity" className="row-start-1 text-red-500 col-start-3">
                   $ {Math.round(orderTotal)}.00
                  </span>
                  <span id="discount-heading" className="row-start-2 col-start-1">
                    Sale Discount
                  </span>
                  <span id="discount-quantity" className="row-start-2 col-start-3 text-green-500">
                    $ 5 %
                  </span>
                  <span
                  ...
                  <span id="shipping-price" className="row-start-4 col-start-3 text-red-500">
...
<button type='button' onClick={handleProceedToPayment} className=' flex text-center font-bold justify-center text-white bg-blue-500 rounded-xl h-[10%] w-full mt-4 text-2xl active:bg-white active:text-blue-500 active:translate-y-[4px] ' id='proceed-payment'>Proceed to Payments 
